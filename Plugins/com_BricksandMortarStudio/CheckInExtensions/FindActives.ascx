<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FindActives.ascx.cs" Inherits="Plugins.com_bricksandmortarstudio.CheckInExtensions.FindActives" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-heading">
                <h1 class="panel-title"><i class="fa fa-check-square-o"></i>Active Attendees</h1>
            </div>
